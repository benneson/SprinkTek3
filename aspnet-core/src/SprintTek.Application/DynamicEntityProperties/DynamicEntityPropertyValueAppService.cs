...
using SprintTek.DynamicEntityPropertyValues.Dto;

namespace SprintTek.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : SprintTekAppServiceBase, IDynamicEntityPropertyValueAppService
    {
