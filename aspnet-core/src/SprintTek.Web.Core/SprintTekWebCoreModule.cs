...
using SprintTek.Web.Authentication.JwtBearer;
using SprintTek.Web.Authentication.TwoFactor;
using SprintTek.Web.Chat.SignalR;
using SprintTek.Web.Configuration;
using SprintTek.Web.DashboardCustomization;

namespace SprintTek.Web
{
    [DependsOn(
        typeof(SprintTekApplicationModule),
        typeof(SprintTekEntityFrameworkCoreModule),
    ...
    public class SprintTekWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SprintTekWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SprintTekApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SprintTekWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SprintTekWebCoreModule).Assembly);
        }
