...
using SprintTek.Authorization.Delegation;
using SprintTek.Authorization.Ldap;
using SprintTek.Authorization.Roles;
using SprintTek.Authorization.Users;
using SprintTek.Chat;
using SprintTek.Configuration;
using SprintTek.DashboardCustomization.Definitions;
using SprintTek.Debugging;
using SprintTek.DynamicEntityProperties;
using SprintTek.Features;
using SprintTek.Friendships;
using SprintTek.Friendships.Cache;
using SprintTek.Localization;
using SprintTek.MultiTenancy;
using SprintTek.Net.Emailing;
using SprintTek.Notifications;
using SprintTek.WebHooks;

namespace SprintTek
{
    [DependsOn(
        typeof(SprintTekCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SprintTekCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SprintTekLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SprintTekConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SprintTekMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SprintTekSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SprintTekCoreModule).GetAssembly());
        }
